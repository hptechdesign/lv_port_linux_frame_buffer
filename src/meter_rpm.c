...
void meter_rpm(void)
{
    ...
    lv_meter_set_indicator_end_value(meter, indic, 600);
    ...
    lv_meter_set_indicator_start_value(meter, indic, 2400);
    lv_meter_set_indicator_end_value(meter, indic, 3000);
