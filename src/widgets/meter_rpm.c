...
void meter_rpm(void)
{
    ...
    lv_meter_set_scale_range(meter, scale, METER_RPM_MIN, METER_RPM_MAX, 270,
                             135);
    ...
    lv_meter_set_indicator_start_value(meter, indic, METER_RPM_MIN);
    lv_meter_set_indicator_end_value(meter, indic, METER_RPM_LOW_THRESH);
    ...
    lv_meter_set_indicator_start_value(meter, indic, METER_RPM_HIGH_THRESH);
    lv_meter_set_indicator_end_value(meter, indic, METER_RPM_MAX);
    ...
    lv_obj_set_width(
        label1, METER_RPM_SIZE); /*Set smaller width to make the lines wrap*/
    lv_obj_set_style_text_align(label1, LV_TEXT_ALIGN_CENTER, 0);
    lv_obj_set_pos(label1, METER_RPM_XPOS,
                   METER_RPM_YPOS + METER_RPM_SIZE - 45);
    ...
    lv_anim_set_values(&a, METER_RPM_MIN, METER_RPM_HIGH_THRESH);
