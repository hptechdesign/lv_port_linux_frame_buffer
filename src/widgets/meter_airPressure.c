...
void meter_airPressure(void)
{
    ...
    lv_obj_set_pos(meter, METER_AIRP_XPOS, METER_AIRP_YPOS);
    lv_obj_set_size(meter, METER_AIRP_SIZE, METER_AIRP_SIZE);

    /*Add a scale first*/
    lv_meter_scale_t * scale = lv_meter_add_scale(meter);
    lv_meter_set_scale_range(meter, scale, METER_AIRP_MIN, METER_AIRP_MAX, 270,
                             135);
    ...
    lv_meter_set_indicator_start_value(meter, indic, METER_AIRP_MIN);
    lv_meter_set_indicator_end_value(meter, indic, METER_AIRP_LOW_THRESH);
    ...
    lv_meter_set_indicator_start_value(meter, indic, METER_AIRP_HIGH_THRESH);
    lv_meter_set_indicator_end_value(meter, indic, METER_AIRP_MAX);
    ...
    lv_obj_set_width(
        label1, METER_AIRP_SIZE); /*Set smaller width to make the lines wrap*/
    lv_obj_set_style_text_align(label1, LV_TEXT_ALIGN_CENTER, 0);
    lv_obj_set_pos(label1, METER_AIRP_XPOS,
                   METER_AIRP_YPOS + METER_AIRP_SIZE -
                       METER_AIRP_LABEL_YOFFSET);
    ...
    lv_anim_set_values(&a, METER_AIRP_MIN, METER_AIRP_HIGH_THRESH);
