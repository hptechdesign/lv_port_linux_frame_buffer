...
void meter_oilPressure(void)
{
    ...
    lv_meter_set_scale_range(meter, scale, METER_OILP_MIN, METER_OILP_MAX, 270, 135);
    ...
    lv_label_set_text(label1, "#ffffff Oil Pressure, Bar");
    lv_obj_set_width(label1, METER_OILP_SIZE);  /*Set smaller width to make the lines wrap*/
    lv_obj_set_style_text_align(label1, LV_TEXT_ALIGN_CENTER, 0);
    lv_obj_set_pos(label1, METER_OILP_XPOS, METER_OILP_YPOS+METER_OILP_SIZE-METER_OILP_LABEL_YOFFSET);
    lv_obj_set_style_text_font(label1, METER_OILP_FONT, LV_PART_MAIN);
